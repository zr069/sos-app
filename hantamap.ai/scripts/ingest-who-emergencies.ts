/**
 * Ingest WHO Emergencies Disease Outbreak News
 * Source: https://www.who.int/api/emergencies/diseaseoutbreaknews
...
const PROVIDER = 'who-emergencies'
const API_URL = 'https://www.who.int/api/emergencies/diseaseoutbreaknews'
...
async function fetchItems(): Promise<any[]> {
  ...
  if (!res.ok) {
    throw new Error(`WHO Emergencies API returned ${res.status}: ${res.statusText}`)
  }
...
export async function ingestWhoEmergencies() {
